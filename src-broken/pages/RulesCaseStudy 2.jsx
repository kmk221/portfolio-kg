...
function PartBFeatureTabs({tabs}) {
  ...
  return (
    <div>
      ...
      <div style={{position:'relative',borderRadius:12,overflow:'hidden',background:'var(--bg)',border:`1px solid ${borderLight}`}}>
        {/* After layer */}
  ...
  return (
    <div style={{background:'white',borderRadius:12,border:`1px solid ${borderLight}`,overflow:'hidden'}}>
      <div style={{display:'grid',gridTemplateColumns:'2fr 3fr',alignItems:'stretch'}}>
        ...
        <div style={{background:'var(--bg)',display:'flex',alignItems:'center',justifyContent:'center',padding:24,position:'relative',minHeight:240}}>
