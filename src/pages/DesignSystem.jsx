      ...
      <div style={{ maxWidth: 1240, margin: '0 auto', padding: '80px 64px' }}>
        ...
        <Section title="Color — Ochre">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 16 }}>
            ...
            <Swatch bg="var(--ochre-deep)" label="--ochre-deep  #BF933F" />
        ...
        <Section title="Color — Slate">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 16 }}>
            ...
            <Swatch bg="var(--slate-deep)" label="--slate-deep  #718C8F" />
            <Swatch bg="var(--slate-tint)" label="--slate-tint  #A5BCBD" />
            <Swatch bg="var(--slate-edge)" label="--slate-edge  #718C8F" />
          </div>
        </Section>
        ...
        <Section title="Type Families">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 48 }}>
            {[
              { name: '--f-serif', label: 'Crimson Pro', spec: 'Editorial serif — H1, H2, lede, voice', sample: 'Abcdefghijklmnopqrstuvwxyz', style: { fontFamily: 'var(--f-serif)', fontSize: 28, fontWeight: 300 } },
              { name: '--f-sans', label: 'Plus Jakarta Sans', spec: 'Body + UI — all running text', sample: 'Abcdefghijklmnopqrstuvwxyz', style: { fontFamily: 'var(--f-sans)', fontSize: 22, fontWeight: 400 } },
              { name: '--f-mono', label: 'JetBrains Mono', spec: 'Eyebrow + data labels', sample: 'ABCDEFGHIJKLMNOPQRST 0123456789', style: { fontFamily: 'var(--f-mono)', fontSize: 16, fontWeight: 500, letterSpacing: '0.08em' } },
              { name: '--f-script', label: 'Permanent Marker', spec: 'Script accent — display use only', sample: 'Kristin', style: { fontFamily: 'var(--f-script)', fontSize: 32 } },
            ].map(({ name, label, spec, sample, style }) => (
              <div key={name} style={{
