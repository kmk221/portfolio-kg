    ...
    <div style={{ background: 'var(--bg)', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: 1240, margin: '0 auto', padding: '80px 64px' }}>
        ...
        <Section title="Color — Ochre">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 16 }}>
            <Swatch bg="var(--ochre)"      label="--ochre / --ochre-deep  #BF933F" />
            <Swatch bg="var(--ochre-ink)"  label="--ochre-ink  #7A5A1C (text)" />
        ...
        <Section title="Components — Callout Patterns">
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div style={{
              ...
              <p className="eyebrow" style={{ marginBottom: 6, display: 'block', color: 'var(--ink-2)' }}>Shipped in V1</p>
              <p className="small" style={{ margin: 0, color: 'var(--ink-3)' }}>
